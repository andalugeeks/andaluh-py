...
def test1():
    ...
    assert andaluh.epa('Oye sexy psiquiatra @miguel, la #web HTTPS://andaluh.es/transcriptor no sale en google.es pero si en http://google.com?utm=13_123.html #porqueseñor', escape_links=True) == 'Oye çêççy çiquiatra @miguel, la #web HTTPS://andaluh.es/transcriptor no çale en google.es pero çi en http://google.com?utm=13_123.html #porqueseñor'
# Lemario test
