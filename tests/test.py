...
assert epa.cas_to_epa('Transportandonos a la connotación del abstracto solsticio, el aislante plástico adsorvente asfixió al pseudoescritor con aMNesia para ConMemorar broncas adscritas') == u'Trâpportandonô a la cônnotaçión dêh âttrâtto çorttiçio, el aîl-lante pláttico âççorbente âffîççió al çeudoêccritôh con âNNeçia para CôMMemorâh broncâ âccritâ'
