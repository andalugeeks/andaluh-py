...
assert epa.cas_to_epa('Transportandonos a la connotación del abstracto solsticio, el aislante plástico adsorvente asfixió al aMnésico pseudoescritor granadino de constituciones, para ConMemorar broncas adscritas') == u'Trâpportandonô a la cônnotaçión dêh âttrâtto çorttiçio, el aîl-lante pláttico âççorbente âffîççió al ânnéçico çeudoêccritôh granadino de côttituçionê, para CôMMemorâh broncâ âccritâ'
